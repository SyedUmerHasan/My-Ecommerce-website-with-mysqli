<?php
  ...
  $db = new Database("ecommerce","user");
  $db->ActivateAccount();
 ?>
<?php ; ?><!doctype html>
<html>
<head>
<title>orderkarao.pk an Ecommerce Online Shopping Category Flat Bootstrap Responsive Website Template | Login :: w3layouts</title>
<!-- for-mobile-apps -->
...
<!-- login -->
	<div class="login">
		<div class="container">
			<h2>Validation of Account</h2>

			<div class="login-form-grids animated wow slideInUp" data-wow-delay=".5s">
        <?php
        echo $_SESSION["activatemessage"];
         ?>
			</div>
		</div>
	</div>
