...
$item_price = urldecode($_GET["item_price"]);
$item_discountprice = urldecode($_GET["item_discountprice"]);
$item_description = urldecode($_GET["item_description"]);
$item_imagelocation = urldecode($_GET["item_imagelocation"]);
$item_category= urldecode($_GET["item_category"]);
$item_discountamount = urldecode($_GET["item_discountamount"]);
...
<html>
<head>
<title>orderkarao.pk an Ecommerce Online Shopping Category Flat Bootstrap Responsive Website Template | Single Page :: w3layouts</title>
<!-- for-mobile-apps -->
	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active"><?php echo $subcategory ?></li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
		...
		<div class="container">
			<div class="agileinfo_single">
				...
				<div class="col-md-4 agileinfo_single_left">
					<img id="example" src="<?php echo $item_imagelocation ?>" alt=" " class="img-responsive">
				</div>
				...
				<h2><?php echo $item_name ?></h2>
					...
					<div class="snipcart-item block">
						<div class="snipcart-thumb agileinfo_single_right_snipcart">
							<h4 class="m-sing"><?php echo $item_discountprice.'PKR' ?> <span><?php echo $item_price.'PKR' ?></span></h4>
						</div>
						<div class="snipcart-details top_brand_home_details">
							<form action="#" method="post">
								<fieldset>
									...
									<input type="hidden" name="discount_amount" value="<?php echo $item_discountamount ?>">
...
<div class="footer">
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2017 orderkarao.pk. All rights reserved | Design by <a href="http://w3layouts.com/">W3layouts</a></p>
			</div>
		</div>
